...
BEGIN
    OPEN CUR_GENERIC FOR
		...
		inner join MITKC_IRB_ATTACHMENT_PROTOCOL t2 on t1.PROTOCOL_ID = t2.PROTOCOL_ID
		inner join MITKC_IRB_ATTACHMENT_TYPE t3 on t2.type_cd = t3.type_cd
		left outer join KC_PERSON_MV t4 on (t4.PRNCPL_NM) = (t2.update_user)
