...
BEGIN
    OPEN CUR_GENERIC FOR
		...
		INNER JOIN MITKC_IRB_PROTO_FUNDING_SOURCE t2 on t1.PROTOCOL_ID = t2.PROTOCOL_ID
		INNER JOIN FUNDING_SOURCE_TYPE	t3 on t2.FUNDING_SOURCE_TYPE_CODE = t3.FUNDING_SOURCE_TYPE_FLAG
