...
BEGIN
    OPEN CUR_GENERIC FOR
		...
		INNER JOIN MITKC_IRB_PROTO_VULNERABLE_SUB t2 on t1.PROTOCOL_ID = t2.PROTOCOL_ID
		INNER JOIN VULNERABLE_SUBJECT_TYPE	t3 on t2.VULNERABLE_SUBJECT_TYPE_CODE = t3.VULNERABLE_SUBJECT_TYPE_CODE
