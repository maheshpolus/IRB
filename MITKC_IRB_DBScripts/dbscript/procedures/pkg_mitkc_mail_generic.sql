...
ls_exempt_title		 	  IRB_PERSON_EXEMPT_FORM.EXEMPT_TITLE%TYPE;
li_pi_person_id			  IRB_PERSON_EXEMPT_FORM.PERSON_ID%TYPE;
ls_pi_name				  IRB_PERSON_EXEMPT_FORM.PERSON_NAME%TYPE;	 
ls_faculty_sponsor		  OSP$PERSON.FULL_NAME%TYPE;
ls_determination		  VARCHAR2(20);
li_pi_email				  OSP$PERSON.EMAIL_ADDRESS%TYPE;
ls_exempt_form_status     IRB_EXEMPT_FORM_STATUS.DESCRIPTION%TYPE;
BEGIN
    ...
    IF av_notification_type = 'EXEMPT' THEN
        BEGIN
            ...
            FROM
            IRB_PERSON_EXEMPT_FORM T1
            LEFT OUTER JOIN OSP$PERSON T2 ON T1.FACULTY_SPONSOR_PERSON_ID = T2.PERSON_ID
            LEFT OUTER JOIN IRB_EXEMPT_FORM_STATUS T3 ON T1.EXEMPT_STATUS_CODE = T3.EXEMPT_STATUS_CODE
