...
export class ViewQuestionnaireService {
  ...
  getQuestionnaire(data) {
    return this.http.post('/irb/getQuestionnaire', data );
  }
  saveQuestionnaire(data, filesArray) {
    ...
    formData.append('formDataJson', JSON.stringify(data));
     return this.http.post('irb/saveQuestionnaireModule', formData);
  }

  downloadAttachment(attachmentId) {
    return this.http.post( 'irb/downloadQuesAttachment',
