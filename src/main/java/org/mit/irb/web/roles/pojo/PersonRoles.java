...
public class PersonRoles implements Serializable{
	...
	@JoinColumn(foreignKey = @ForeignKey(name = "IRB_PERSON_ROLES_FK3"), name = "PERSON_ID", referencedColumnName = "PERSON_ID", insertable = false, updatable = false)
	...
	@ManyToOne(optional = false)
	@JoinColumn(foreignKey = @ForeignKey(name = "IRB_PERSON_ROLES_FK1"), name = "ROLE_ID", referencedColumnName = "ROLE_ID", insertable = false, updatable = false)
	private Role role;
